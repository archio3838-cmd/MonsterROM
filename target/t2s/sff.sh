...
# SEC Floating Feature configuration file for Galaxy A51 (a51)
...
SEC_FLOATING_FEATURE_CAMERA_CONFIG_UW_DISTORTION_CORRECTION=0,109,2,19010102,4000,3000,0,0,0,1
...
# Device specific
SEC_FLOATING_FEATURE_SETTINGS_CONFIG_BRAND_NAME=Galaxy M30S
SEC_FLOATING_FEATURE_SETTINGS_CONFIG_DEFAULT_FONT_SIZE=3
SEC_FLOATING_FEATURE_SETTINGS_CONFIG_FCC_ID=A3LSMA515FN

# Frameworks
SEC_FLOATING_FEATURE_SYSTEM_CONFIG_SIOP_POLICY_FILENAME=siop_a51_exynos9611

# Lockscreen
SEC_FLOATING_FEATURE_LOCKSCREEN_CONFIG_PUNCHHOLE_VI=face,pos:0.5:0.025,size:0.142:0.059,type:circle
