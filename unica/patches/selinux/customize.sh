...
LOG_STEP_IN "- delete qcom mappings"
# Deleting mapping from product and system_ext
DELETE_FROM_WORK_DIR "system" "system/system_ext/etc/selinux/mapping"
DELETE_FROM_WORK_DIR "product" "etc/selinux/mapping"
LOG_STEP_OUT
